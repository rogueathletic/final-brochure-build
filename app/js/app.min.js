! function (e, t) {
    ...
    ! function () {
        ...
        function t(t, o) {
            if (this.el = t, this.$el = e(t), this.s = e.extend({}, s, o),
        ...
        t.prototype.init = function () {
            ...
            s.indexOf("lg=" + this.s.galleryId) > 0 && (t.index = parseInt(s.split("&slide=")[1], 10),
                e("body").addClass("lg-from-hash"), e("body").hasClass("lg-on") || (setTimeout(function () {
                    t.build(t.index)
                }), e("body").addClass("lg-on"))), t.s.dynamic ? (t.$el.trigger("onBeforeOpen.lg"),
                t.index = t.s.index || 0,
            ...
            s.structure(), e.each(e.fn.lightGallery.modules, function (t) {
                ...
                }), s.slide(t, !1, !1, !1), s.s.keyPress && s.keyPress(),
                s.$items.length > 1 ? (s.arrow(), setTimeout(function () {
                    s.enableDrag(), s.enableSwipe()
                }, 50), s.s.mousewheel && s.mousewheel()) : s.$slide.on("click.lg", function () {
                    s.$el.trigger("onSlideClick.lg")
                }), s.counter(), s.closeGallery(), s.$el.trigger("onAfterOpen.lg"),
            ...
            var t, s = "",
                ...
                a = "",
                l = this;
            for (e("body").append('<div class="lg-backdrop"></div>'), e(".lg-backdrop").css("transition-duration",
                    this.s.backdropDuration + "ms"), i = 0; i < this.$items.length; i++) s += '<div class="lg-item"></div>';
            if (this.s.controls && this.$items.length > 1 && (o = '<div class="lg-actions"><button class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (a = '<div class="lg-sub-html"></div>'),
                t = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + s + '</div><a class="caldera-link"><span class="lg-icon" id="lg-link-home"></span></a><div class="lg-toolbar lg-group"><span class="lg-icon pdf"></span></div>' + o + a + "</div></div>",
                e("body").append(t), this.$outer = e(".lg-outer"),
                this.$slide = this.$outer.find(".lg-item"),
                this.s.useLeft ? (this.$outer.addClass("lg-use-left"),
                    this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"),
                l.setTop(), e(window).on("resize.lg orientationchange.lg",
                    function () {
                        setTimeout(function () {
                            l.setTop()
                        }, 100)
            ...
            setTimeout(function () {
                ...
                e('.pdf').attr('type', 'button');
                e('.pdf').on('click tap', function () {
                    "use strict";
                    axios({
                        ...
                        var iosFirefox = navigator.userAgent.match("FxiOS");
                        var iosChrome = navigator.userAgent.match("CriOS");
                        var iosOpera = navigator.userAgent.match("OpiOS");
                        if (iosFirefox == true) {
                            window.open('./caldera-spas-2020-brochure.pdf');
                        } else if (iosChrome == true) {
                            window.open('./caldera-spas-2020-brochure.pdf');
                        } else if (iosOpera == true) {
                            window.open('./caldera-spas-2020-brochure.pdf');
                        } else {
                            var url = window.URL.createObjectURL(new Blob([response.data]));
                            var link = document.createElement('a');
                            link.href = url;
                            link.setAttribute('download', 'Caldera Spas Brochure | 2020.pdf');
        ...
        s.prototype.init = function () {
            ...
            function t(e, t, s) {
                var l, r = o.core.isVideo(e, s) || {},
                    n = "";
                r.youtube || r.vimeo || r.dailymotion ? r.youtube ? l = o.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + r.youtube[1] + "/" + o.core.s.youtubeThumbSize + ".jpg" : t : r.vimeo ? o.core.s.loadVimeoThumbnail ? (l = "//i.vimeocdn.com/video/error_" + a + ".jpg", n = r.vimeo[1]) : l = t : r.dailymotion && (l = o.core.s.loadDailymotionThumbnail ? "//www.dailymotion.com/thumbnail/video/" + r.dailymotion[1] : t) : l = t,
                    i += '<div data-vimeo-id="' + n + '" class="lg-thumb-item" style="width:' + o.core.s.thumbWidth + "px; height: " + o.core.s.thumbHeight + "; margin-right: " + o.core.s.thumbMargin + 'px"><img src="' + l + '" /></div>', n = ""
            }
            var s, o = this,
                i = "",
                a = "",
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            s += t.core.s.menuLinkOne ? '<li><a id="menu-link-one" alt="' + this.core.s.menuLinkOneText + '" title="' + this.core.s.menuLinkOneText + '"><span class="lg-dropdown-text">' + this.core.s.menuLinkOneText + "</span></a></li>" : "",
                ...
                s += "</ul></span>", this.core.$outer.find(".lg-toolbar").prepend(s), this.core.$outer.find(".lg").append('<div id="lg-dropdown-overlay"></div>'),
