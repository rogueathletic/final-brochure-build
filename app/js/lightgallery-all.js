...
function (a, b) {
      ...
      ! function () {
            ...
            c.prototype.init = function () {
                  ...
                  c += b.core.s.perfectFit ? '<li><a id="lg-jump-perfect-fit"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.discoverYourPerfectFitText + "</span></a></li>" : "", 
                  
                  c += b.core.s.specifications ? '<li><a id="lg-jump-detailed-specifications"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.detailedSpecificationsText + "</span></a></li>" : "", 
                  
                  c += b.core.s.essentials ? '<li><a id="lg-jump-essentials-and-accessories"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.essentialsAndAccessoriesText + "</span></a></li>" : "", 
                  
                  c += b.core.s.warranty ? '<li><a id="lg-jump-warranty"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.warrantyText + "</span></a></li>" : "", 

                  c += "</ul></span>", this.core.$outer.find(".lg-toolbar").prepend(c), this.core.$outer.find(".lg").append('<div id="lg-dropdown-overlay"></div>'), 
